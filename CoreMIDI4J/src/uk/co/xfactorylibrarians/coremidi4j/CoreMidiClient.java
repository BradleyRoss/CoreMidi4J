...
public class CoreMidiClient {
   ...
   *    
   * <p>Used to make sure we are only running one callback delivery loop at a time without having to serialize the process
   * in a way that will block the actual CoreMidi callback.</p>
   */
